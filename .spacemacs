...
(custom-set-variables
 ...
 '(package-selected-packages
   '(cargo lsp-docker lsp-mode flycheck-rust racer rust-mode eldoc pos-tip yaml ron-mode toml-mode helm-dash sqlup-mode sql-indent popwin godoctor go-tag go-rename go-impl go-guru go-gen-test go-fill-struct go-eldoc flycheck-golangci-lint company-go go-mode yaml-mode yapfify window-purpose imenu-list stickyfunc-enhance sphinx-doc pytest pyenv-mode pydoc py-isort poetry transient pippel pipenv pyvenv pip-requirements nose lsp-python-ms lsp-pyright live-py-mode importmagic epc ctable concurrent deferred helm-pydoc helm-cscope xcscope dap-mode lsp-treemacs bui cython-mode company-anaconda blacken anaconda-mode pythonic typescript-mode web-mode tagedit slim-mode scss-mode sass-mode pug-mode helm-css-scss haml-mode emmet-mode counsel-css company-web web-completion-data web-beautify tern prettier-js npm-mode nodejs-repl livid-mode skewer-mode js2-refactor yasnippet multiple-cursors js2-mode js-doc import-js grizzl impatient-mode htmlize simple-httpd helm-gtags ggtags evil-matchit spinner counsel-gtags add-node-modules-path vmd-mode valign smartparens mmm-mode markdown-toc markdown-mode gh-md emoji-cheat-sheet-plus helm helm-core company-emoji company wgrep smex ivy-xref ivy-hydra ivy-avy counsel swiper ivy which-key use-package treemacs-projectile treemacs-icons-dired quickrun pcre2el overseer nameless macrostep inspector hybrid-mode helm-xref helm-themes helm-swoop helm-projectile helm-org helm-mode-manager helm-make helm-ls-git helm-flx helm-descbinds helm-ag flycheck-package flycheck-elsa evil-mc emr elisp-slime-nav dotenv-mode diminish bind-map auto-compile ace-jump-helm-line))
